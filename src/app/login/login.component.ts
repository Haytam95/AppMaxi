...
export class LoginComponent implements OnInit {
  ...
  loggedIn() {
    this.messageService.add({ key: 'tc', severity: 'success', summary: 'Logeado', detail: 'Te has logeado correctamente' });
  }

  ngDoCheck() {
    if (!this.authenticationService.displayModal) {
